...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TelaLogin_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TelaLogin_t qt_meta_stringdata_TelaLogin = {
    {
        QT_MOC_LITERAL(0, 9),  // "TelaLogin"
...
Q_CONSTINIT static const uint qt_meta_data_TelaLogin[] = {
...
Q_CONSTINIT const QMetaObject TelaLogin::staticMetaObject = { {
    ...
    qt_meta_stringdata_TelaLogin.offsetsAndSizes,
    qt_meta_data_TelaLogin,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TelaLogin_t,
        // Q_OBJECT / Q_GADGET
