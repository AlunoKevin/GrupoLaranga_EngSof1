...
public:
    ...
    void setupUi(QWidget *TelaTriagem)
    {
        ...
        btnSalvarTriagem->setObjectName("btnSalvarTriagem");
        ...
        txtNomePaciente->setObjectName("txtNomePaciente");
